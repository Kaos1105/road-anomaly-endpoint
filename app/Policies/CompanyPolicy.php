...
class CompanyPolicy extends BasePolicy
{
    ...
    public function store(): Response
    {
        ...
        $screenContent = $this->getScreenContent(ScreenCodeEnum::COMPANY_ADD, ContentNoEnum::getContentNo(ContentNoEnum::COMMON_REGISTRATION_CONTENTS, 'REGISTRATION'));
    ...
    {
        $accessPermission = $this->getEmployeePermission(SystemCodeEnum::ORGANIZATION);
        $screenContent = $this->getScreenContent(ScreenCodeEnum::COMPANY_DISPLAY, ContentNoEnum::getContentNo(ContentNoEnum::COMMON_DISPLAY_HEADER_CONTENTS, 'DELETE'));
        return $this->checkPermission($screenContent, $accessPermission);
    }
    ...
    {
        $accessPermission = $this->getEmployeePermission(SystemCodeEnum::ORGANIZATION);
        $screenContent = $this->getScreenContent(ScreenCodeEnum::COMPANY_DISPLAY, ContentNoEnum::getContentNo(ContentNoEnum::COMPANY_DISPLAY_CONTENTS, 'SITE_REPRESENTATIVE'));
        return $this->checkPermission($screenContent, $accessPermission);
    }
}
