...
class ProductPolicy extends BasePolicy
{
    ...
    public function store(): Response
    {
        ...
        $screenContent = $this->getScreenContent(ScreenCodeEnum::PRODUCT_ADD, ContentNoEnum::getContentNo(ContentNoEnum::COMMON_REGISTRATION_CONTENTS, 'REGISTRATION'));
    ...
    {
        $accessPermission = $this->getEmployeePermission(SystemCodeEnum::SOCIAL);
        $screenContent = $this->getScreenContent(ScreenCodeEnum::PRODUCT_DISPLAY, ContentNoEnum::getContentNo(ContentNoEnum::COMMON_DISPLAY_HEADER_CONTENTS, 'DELETE'));
        return $this->checkPermission($screenContent, $accessPermission);
    }
}
