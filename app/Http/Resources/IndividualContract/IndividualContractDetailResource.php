 ...
 */
class IndividualContractDetailResource extends JsonResource
{
    /**
    ...
    public function toArray(Request $request): array
    {
        ...
        return [
            'id' => $this->id,
            'basic_contract' => $this->whenLoaded('basicContract', fn() => BasicContractItemResource::make($this->basicContract)),
            'name' => $this->name,
