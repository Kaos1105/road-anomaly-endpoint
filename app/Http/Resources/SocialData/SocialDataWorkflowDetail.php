 ...
 * @mixin   SocialData
 */
class SocialDataWorkflowDetail extends JsonResource
{
    /**
     * Transform the resource into an array.
     *
    ...
    public function toArray(Request $request): array
    {
        ...
        [$isEnabledBtnEdit, $isEnabledBtnWorkflow] = SocialDataHelper::socialDataBtnFLg($this->resource);
        ...
        return [
            ...
            'current_workflow' => $this->whenLoaded('workflows', function () {
                $currentWorkflow = $this->workflows->filter(function (Workflow $workflow) {
                    return $this->data_progress == $workflow->workflow_order;
                })->first();
                return WorkflowItemResource::make($currentWorkflow)->setParams($this->socialEvent);
            }),
            'memo' => $this->memo,
