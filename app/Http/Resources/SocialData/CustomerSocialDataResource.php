...
use App\Http\Resources\Customer\SocialCustomerItemResource;
 ...
 * @mixin   SocialData
 */
class CustomerSocialDataResource extends JsonResource
{
    /**
     * Transform the resource into an array.
     *
    ...
    public function toArray(Request $request): array
    {
        ...
        return [
            ...
            'customer' => $this->whenLoaded('customer', fn() => SocialCustomerItemResource::make($this->customer)),
