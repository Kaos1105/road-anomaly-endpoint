 ...
 * @mixin Reservation
 */
class ReservationCalendarItemResource extends JsonResource
{
    protected bool $isDuplicated = false;

    public function setParams(bool $isDuplicated): self
    {
    ...
    public function toArray(Request $request): array
    {
        return [
            ...
            'reservation_date' => DateTimeHelper::formatDateTime($this->reservation_date, DateTimeEnum::DATE_FORMAT),
