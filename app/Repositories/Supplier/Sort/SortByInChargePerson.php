...
class SortByInChargePerson implements Sort
{
    public function __invoke(Builder $query, bool $descending, string $property): void
    {
        $direction = $descending ? SortDirection::DESCENDING : SortDirection::ASCENDING;
        $query->leftJoin('organization_employees', 'social_suppliers.my_company_person_id', '=', 'organization_employees.id')
            ...
            ->orderByRaw("organization_employees.display_order {$direction}")
